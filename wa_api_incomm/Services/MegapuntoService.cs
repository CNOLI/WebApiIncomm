...
{
    public class MegapuntoService
    {
        public int nu_id_convenio = 7;
        ...
        public MegapuntoService(Serilog.ILogger logger)
        {
            _logger = logger;
        }
        public object RealizarRecarga(string conexion, Megapunto_Input model)
        {
            bool ins_bd = false;
            ...
            try
            {
                ...
                MegaPuntoApi api = new MegaPuntoApi(hub_convenio);

                Megapunto_InputModel model_api = new Megapunto_InputModel();
                ...
                if (response.codigo == "00")
                {
                    ...
                    trx.vc_cod_autorizacion = (response.cod_autorizacion == null) ? "" : response.cod_autorizacion.ToString();
                ...
                else
                {
                    ...
                    tm.vc_cod_error = response.codigo;

                    tm.vc_desc_error = response.mensaje;
