...
namespace wa_api_incomm.Services.Contracts
{
    public interface ISentinelService
    {
        ...
        object sel_tipo_documento_identidad(string conexion, Sentinel_InputModel.Busqueda input);
        object sel_producto(string conexion, Sentinel_InputModel.Busqueda input);
        ...
        object get_validar_titular(SentinelInfo info, Sentinel_InputModel.Solicitante model);
