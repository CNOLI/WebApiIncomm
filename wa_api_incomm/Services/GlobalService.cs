...
namespace wa_api_incomm.Services
{
    public class GlobalService
    {
        ...
        private TipoDocIdentidadModel get_tipo_documento(SqlConnection cn, int nu_id_tipo_doc_identidad, int nu_id_convenio)
        {
        ...
        private TipoDocIdentidadModel get_tipo_documento_codigo(SqlConnection cn, string vc_cod_tipo_doc_identidad, int nu_id_convenio)
        {
            TipoDocIdentidadModel _result = new TipoDocIdentidadModel();
            TipoDocIdentidadModel model = new TipoDocIdentidadModel();
            using (var cmd = new SqlCommand("tisi_global.usp_get_tipo_doc_identidad", cn))
